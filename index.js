...
var S = {
  init: function () {
    ...
    if (i !== -1) {
      ...
      S.UI.simulate('|#countdown 3||睡神|张莉莉|请你|点一下屏幕|我给你|放个|屁|NO|放个烟花|今天|是11月13号|你夜夜思念的|男朋友|给你|送祝福来啦|祝我的|可爱女人|张莉莉|生|日|快|乐|#rectangle|新的|一岁|小菜牙|要永远|开心哦|还有一点|之后的|每一天|我们两|要一起|开开心心|谁也不能|把对方|落下哦|');
    }
